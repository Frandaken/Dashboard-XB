...
async function fetchWithRetry(url, headers = {}, timeoutMs = 12000) {
...
app.get('/api/health', (req, res) => {
  res.json({ status: 'ok', service: 'dashboard-xb-backend', time: new Date().toISOString() });
});

// Proxy route for Google Calendar feeds
